      ...
      <AppWrapper>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <AnimatedElement className="bg-gradient-to-r from-purple-600 to-purple-700 border-purple-800 bg-purple-600 hover:bg-purple-700 text-gray-900 dark:text-white flex items-center justify-center md:justify-start rounded-lg shadow p-6" variant="fadeInUp" delay={0.8} duration={0.5}>
              <div className="flex items-center">
